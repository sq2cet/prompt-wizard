...
- Compliance:     none
- Hosting:        local
- Forced tech:    vanilla HTML/CSS/JavaScript, no build step, no external dependencies. One index.html file is acceptable.
- Forbidden tech: Frameworks (React, Vue, etc.); package managers; build tools.
