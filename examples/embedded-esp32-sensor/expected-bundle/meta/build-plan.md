...
## Phase 3: Read temperature from a DS18B20 / SHT30 sensor.

**Verify:** Manually demonstrate this feature end-to-end and capture the smoke-test steps in `meta/test-plan.md`.

## Phase 4: POST JSON {ts, c, rh} to a configurable URL.

**Verify:** Manually demonstrate this feature end-to-end and capture the smoke-test steps in `meta/test-plan.md`.

## Phase 5: Deep-sleep between readings.
...
## Phase 7: Battery-voltage reporting.
