...
Quality bar: **shareable**. Each phase below has a goal, a list of files to create or modify, implementation steps, and explicit verification commands. Only proceed past a phase once its verification passes.
...
**Verify:** Run unit and integration tests; all green

## Phase 7: Deploy / release

**Verify:** Smoke-test the deployed instance against the MUST features
