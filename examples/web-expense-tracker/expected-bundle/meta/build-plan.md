...
## Phase 3: Add an expense (amount, date, category, note).

**Verify:** Manually demonstrate this feature end-to-end and capture the smoke-test steps in `meta/test-plan.md`.

## Phase 4: List expenses for a chosen month.

**Verify:** Manually demonstrate this feature end-to-end and capture the smoke-test steps in `meta/test-plan.md`.

## Phase 5: Show a monthly total per category.
...
## Phase 7: Recurring-expense template.
